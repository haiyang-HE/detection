...
if __name__ == "__main__":
    #图像文件夹所在位置
    img_path = r"C:\Users\Administrator\Desktop\DSB2018\images"
    #标注文件夹所在位置
    txt_path=r"C:\Users\Administrator\Desktop\DSB2018\labels"
    #txt转化成xml格式后存放的文件夹
    xml_path=r"C:\Users\Administrator\Desktop\DSB2018\xml"
