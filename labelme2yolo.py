...
class Labelme2YOLO(object):
    ...
    def _get_label_id_map(self, json_dir):
        ...
        print(OrderedDict([(label, label_id) for label_id, label in enumerate(label_set)]))
    ...
    def convert(self, val_size):
        ...
        for target_dir, json_names in zip(('train/', 'val/'), 
            ...
            for json_name in json_names:
                ...
                # shutil.copyfile(json_path.replace('.json', '.jpg'), os.path.join(self._image_dir_path, target_dir,img_name))
    ...
    def _save_yolo_image(self, json_data, json_name, image_dir_path, target_dir):
        ...
        # shutil.copyfile(os.path.join(os.path.split(os.path.split(os.path.split(image_dir_path)[0])[0])[0],img_name), img_path)
