...
parser.add_argument('-j', default='LISC_DETECTION/annotations/instances_val2017.json',help='JSON file', dest='json', required=True)
parser.add_argument('-o', default='data',help='path to output folder', dest='out',required=True)
...
class COCO2YOLO:
    def __init__(self):
        ...
        print("categories", self.coco_id_name_map)
